...
/* BINDTOOL_HEADER_FILE(usrp_mimo_echotimer_cc.h)                                        */
...
#include <usrp_mimo_echotimer_cc_pydoc.h>
...
void bind_usrp_mimo_echotimer_cc(py::module& m)
{
    ...
    py::class_<usrp_mimo_echotimer_cc,
        ...
        m, "usrp_mimo_echotimer_cc", D(usrp_mimo_echotimer_cc))
        ...
        .def(py::init(&usrp_mimo_echotimer_cc::make),
             ...
             D(usrp_mimo_echotimer_cc, make))

        .def("set_num_delay_samps",
             &usrp_mimo_echotimer_cc::set_num_delay_samps,
             py::arg("num_samps"),
             D(usrp_mimo_echotimer_cc, set_num_delay_samps))

        .def("set_rx_gain",
             &usrp_mimo_echotimer_cc::set_rx_gain,
             py::arg("gain"),
             D(usrp_mimo_echotimer_cc, set_rx_gain))

        .def("set_tx_gain",
             &usrp_mimo_echotimer_cc::set_tx_gain,
             py::arg("gain"),
             D(usrp_mimo_echotimer_cc, set_tx_gain));
}